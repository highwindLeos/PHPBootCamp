...
INSERT INTO `comments` VALUES (1,'30 번 내용에 달립니다.',1,30),(2,'일단은',2,32),(3,'Dacapo 너무 귀엽고 재밌어요.',3,33),(4,'세계를 바꾼 기업',4,29),(5,'나는 MS 안티임.',5,29),(6,'자유의 여신상.',6,2),(7,'Agra 타지마할 궁전.',3,1),(8,'Dacapo SS Kotori',4,3),(9,'두바이~ 부르츠 칼리파.',2,4),(10,'요세미티 산. MAC Thema.',1,5),(11,'시에라 산. Computer의 상징적인 곳.',5,7),(12,'MiKu Kawaii',4,31),(13,'test comments insert for article id 20',3,20),(14,'32번에 달려요.',4,32),(15,'test comments insert for article id 33',3,33),(16,'안녕하세요 테스트 댓글입니다.',3,20),(17,'안녕하세요',4,37),(18,'테스트입니다',4,36);
...
INSERT INTO `follows` VALUES (1,'Yosemite','Laravel',4),(2,'daysmays26','Laravel',4);
...
INSERT INTO `users` VALUES (1,'stonker@gmail.com','이나라','NaraLee','$2y$11$XI1y4aMw9chvpE1F5sfRK.QsVhIbJ/offrYVUlRaBO/nrxiu/1p6u','img/icon/user/usericon00.png'),(2,'highwind26@gmail.com','이승훈','Leodays','$2y$11$/9d2me1vcU3zOSyrGqPpSumAtjTFLViyX6P1DCf6fEwt4nPvnEH0K','img/icon/user/usericon01.png'),(3,'highwind26@nate.com','리윈드','Highwind','$2y$11$ypgWxRCBoQDFbPCl.EPpAuiTPWewIRhy/2f5QPjdMSpNbDeUjAY5.','img/icon/user/usericon02.png'),(4,'highwind26@naver.com','이만화','Laravel','$2y$11$aB.YaarfV.GnbpOYzMTeFuzgLWSFmcYeaOOkwZrhKNL5rV2jg7Kbq','img/icon/user/usericon03.png'),(5,'leosdays@gmail.com','이레오','leosdays26','$2y$11$a880ZshgkR0b8xYPZ6BeNeaCz1iec5.xeIXBPQjAd2RJ89dd5y6P2','img/icon/user/usericon04.png'),(6,'leechar@gmail.com','리차르','CharLee','$2y$11$kqJpAh1qUDJovX9uqsDsbuRCQFyCa9FWOfgrxdCGV2ijhbaox59Ha','img/icon/user/usericon05.png'),(7,'yosemite@gmail.com','이요세','Yosemite','$2y$11$.1OIkXog0nb5gkydreQ9Pele4q6V9R59Z6/eaH4DpitEGdjnGn.tu','img/icon/user/usericon06.png'),(8,'days@gmail.com','이데이','daysmays26','$2y$11$ZplRzLvHdIakRzAlOFzlMeFyZUZaKLkYzakG5TUSg0PynGzkaq7Jq','img/icon/user/usericon07.png');
...
-- Dump completed on 2017-11-20 21:40:45
